...
// Obtener el total cobrado HOY en paid_orders
const getCurrentPaidOrdersTotal = async (req, res) => {
  try {
...
module.exports = { endDay, getAllDailyRevenue, markOrderAsPaid, getDailyPaidOrders, getCurrentPaidOrdersTotal };
